...
import { Shield, Zap, Heart, Users, Globe, Award, Target, Sparkles } from 'lucide-react';
    ...
    <>
      ...
      <main className="min-h-screen pt-20 tablet:pt-24 pb-24">
        ...
        <div className="container-app">
          ...
          >
            {[
              { value: '2.5M+', label: 'Pengguna Aktif', icon: Users },
              { value: '15M+', label: 'Transaksi Sukses', icon: Award },
              { value: '500+', label: 'Game & Produk', icon: Globe },
