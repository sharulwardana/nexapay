            ...
            >
              <form onSubmit={handleSubmit} className="p-6 tablet:p-8 rounded-3xl bg-card/60 border border-border/80 backdrop-blur-2xl shadow-2xl relative space-y-4">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <h2 className="text-lg font-bold font-heading">Kirim Dispatch Support</h2>
                    <p className="text-xs text-muted-foreground">Isi parameter data di bawah ini untuk memulai enkripsi tiket</p>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold font-heading">
                ...
                <button
                  type="submit"
                  disabled={isSending}
                  className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl gradient-primary text-white font-bold font-heading hover:shadow-neon-orange hover:opacity-95 transition-all disabled:opacity-70"
                >
                  {isSending ? (
                    <>
