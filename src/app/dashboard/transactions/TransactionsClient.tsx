      ...
      <main className="min-h-screen pt-28 tablet:pt-32 pb-24 bg-background">
        <div className="container-app max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-lg tablet:text-xl font-bold font-heading">Riwayat Transaksi</h1>
          ...
          <div className="space-y-3 mb-6">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Cari transaksi atau nomor invoice..."
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#121620] border border-white/10 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/25 transition-all"
              />
            </div>
            <div className="flex gap-2 overflow-x-auto no-scrollbar">
              {statusFilters.map((s) => (
                <button
                  ...
                  className={cn(
                    'flex-shrink-0 px-3.5 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border',
                    statusFilter === s ? 'bg-brand-500 text-white font-bold border-transparent shadow-brand' : 'bg-[#121620] border-white/10 text-muted-foreground hover:text-foreground hover:border-white/20'
                  )}
                >
            ...
            {filtered.map((tx) => (
              <div key={tx.id}>
                <Link 
                  ...
                  className="p-3.5 sm:p-4 bg-[#121620] border border-white/10 hover:border-brand-500/40 transition-all block group rounded-2xl shadow-sm"
                >
