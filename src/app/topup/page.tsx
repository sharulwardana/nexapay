    ...
    <>
      <main className="min-h-screen pt-20 tablet:pt-24 pb-24">
        <div className="container-app">
          ...
          {/* Games Grid */}
          <div className="grid grid-cols-2 tablet:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 tablet:gap-4 pb-8">
              ...
              >
                ...
                >
                  ...
                  <div className="relative aspect-[3/4] overflow-hidden">
                    {(() => {
                      const gc = getGameColor(game.slug);
                      return (
                        <>
                          <div className={cn('absolute inset-0 bg-gradient-to-br', gc.from, gc.to, 'group-hover:scale-105 transition-transform duration-500')} />
                    ...
                    {game.denominations.some((d) => d.isFlashSale) && (
                  ...
                  <div className="p-3 tablet:p-4">
                    ...
                    <p className="text-xs font-medium text-primary mt-2">
                      Mulai {formatCurrency(Math.min(...game.denominations.map((d) => d.price)))}
                    </p>
                  </div>
                </Link>
              </motion.div>
