...
// Royal Indigo aligned gradient palettes
const gradients = [
...
export default function PromoCarousel() {
  ...
  return (
    <section ref={ref} className="pt-4 tablet:pt-6 pb-0">
        ...
        >
          ...
          <div className="relative rounded-2xl overflow-hidden aspect-[2/1] tablet:aspect-[3/1] lg:aspect-[3.5/1]">
            ...
            <button
              ...
              className="absolute left-3 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-black/20 backdrop-blur text-white flex items-center justify-center hover:bg-black/30 transition-colors"
              aria-label="Previous"
            >
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-black/20 backdrop-blur text-white flex items-center justify-center hover:bg-black/30 transition-colors"
              aria-label="Next"
            >
