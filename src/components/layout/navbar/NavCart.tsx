        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-16 right-3 w-[calc(100vw-24px)] max-w-sm tablet:absolute tablet:top-full tablet:right-0 tablet:left-auto tablet:w-[360px] tablet:mt-2 bg-card/95 border border-white/15 rounded-2xl shadow-2xl overflow-hidden z-[100] max-h-[70vh] flex flex-col"
            >
